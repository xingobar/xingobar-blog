...
!(function(e, o) {
	...
	e.fn.fullpage = function(j) {
								...
								s.data('fp-styles', s.attr('style')),
									...
									c > 0
										? (function(o, n, t) {
												...
												var s = o.find(B);
												s.length &&
												(0 !== e(w).index(m) || (0 === e(w).index(m) && 0 !== s.index()))
													? _o(s, 'internal')
													: n.eq(0).addClass(u);
											})(s, r, c)
								...
								(function() {
									...
									for (var n = 0; n < e(m).length; n++) {
										...
										void 0 !== a &&
											'' !== a &&
											(i +=
												'<div class="' + A + ' ' + j.navigationPosition + '">' + a + '</div>'),
											(i += '</li>'),
											o.find('ul').append(i);
									}
				...
				? (!(function() {
						...
						var a =
							'onwheel' in n.createElement('div')
								? 'wheel'
								: n.onmousewheel !== i ? 'mousewheel' : 'DOMMouseScroll';
			...
			void 0 !== n
				...
				: (Jo(o, 'all', 'm'),
					o
						...
						: (qe(!1),
							(ie || ae) &&
								(j.autoScrolling && J.off(xe.touchmove), e(l).off(xe.touchstart).off(xe.touchmove))));
		}
		function Ve(o, n) {
			void 0 !== n
				? ((n = n.replace(/ /g, '').split(',')),
			...
			(l.xMovement = (function(e, o) {
				...
				!1 ===
					...
					: (n.addClass(u).siblings().removeClass(u),
						...
						!j.loopHorizontal &&
							j.controlArrows &&
							(a.find(U).toggle(0 !== l.slideIndex), a.find(_).toggle(!n.is(':last-child'))),
						a.hasClass(u) &&
							!l.localIsResizing &&
			...
			(n = o.slidesNav),
				...
				o.localIsResizing ||
					(e.isFunction(j.afterSlideLoad) &&
						j.afterSlideLoad.call(o.destiny, o.anchorLink, o.sectionIndex + 1, o.slideAnchor, o.slideIndex),
					(de = !0),
					uo(o.destiny)),
				(te = !1);
		}
		...
		function Ho(o, n) {
			...
			(t = o),
				j.menu &&
					(e(j.menu).find(h).removeClass(u), e(j.menu).find('[data-menuanchor="' + t + '"]').addClass(u)),
				(i = o),
				(a = n),
				j.navigation &&
		...
		function No(e, o, n, t) {
			...
			j.anchors.length &&
				!j.lockAnchors &&
				(e
					? (void 0 !== n && (i = n), void 0 === o && (o = e), (ee = o), Xo(i + '/' + o))
					: void 0 !== e ? ((ee = o), Xo(n)) : Xo(n)),
				Wo();
		}
		function Xo(e) {
		...
		function Qo(e) {
			...
			j.css3 && j.autoScrolling && !j.scrollBar
				...
				: j.autoScrolling && !j.scrollBar ? le.css('top', -o) : W.scrollTop(o);
		}
		function Go(e) {
